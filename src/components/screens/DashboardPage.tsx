          ...
          <div className="card p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              {todayHealth.steps != null && (
                <div>
                  <p className="text-secondary text-xs">Steps</p>
                  <p className="text-primary font-semibold">{todayHealth.steps.toLocaleString()}</p>
                </div>
              )}
              {todayHealth.restingHr != null && (
                <div>
                  <p className="text-secondary text-xs">Resting HR</p>
                  <p className="text-primary font-semibold">{todayHealth.restingHr} bpm</p>
                </div>
              )}
              {todayHealth.activeCalories != null && (
                <div>
                  <p className="text-secondary text-xs">Active cal</p>
                  <p className="text-primary font-semibold">{todayHealth.activeCalories} kcal</p>
                </div>
              )}
              {todayHealth.sleepHours != null && (
                <div>
                  <p className="text-secondary text-xs">Sleep</p>
                  <p className="text-primary font-semibold">{todayHealth.sleepHours}h</p>
                </div>
              )}
            </div>
          </div>
